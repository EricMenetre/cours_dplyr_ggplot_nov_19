...
Ici, cela implique que partant des données (iris), cette base de données est filtrée de telle manière à ce que Species contiennent uniquement Setosa comme valeur. Cette nouvelle base de données, seule la colonne Sepal.Length va être extraite, et finalement, sur cette colonne, la somme des valeurs va être calculée
